...
class StockBalance(models.Model):
    ...
    quantity = models.DecimalField(max_digits=14, decimal_places=8, default=0.00000000)
...
class Leaderboard(models.Model):
    id = models.AutoField(primary_key=True)
    user_id = models.ForeignKey(APIUser, on_delete=models.CASCADE)
    points = models.IntegerField() # Calculated field in TransactionSerializer.create()
