...
export function navBar() {
    if (localStorage.getItem("access") == "") {
        ...
        // Sign Out Icon
        let navItemSignOut = document.createElement("div");
        navItemSignOut.className = "nav-item"
        navItemSignOut.innerHTML = "<li class='nav-item'> \
                <a class='btn btn-danger d-flex justify-content-center align-items-center' title='Sign Out' aria-current='page' data-bs-toggle='tooltip' data-bs-placement='bottom' data-bs-original-title='Sign Out' href='#' style='border-radius: 50%; height:38.4px;'> \
        ...
        navItemSignOut.onclick = function() {
        ...
        navListAccount.appendChild(navItemSignOut);
